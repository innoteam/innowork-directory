...
require_once('innowork/directory/InnoworkCompany.php');
require_once('innowork/directory/InnoworkContact.php');
...
$gLocale = new LocaleCatalog('innowork-directory::directory_main', \Innomatic\Core\InnomaticContainer::instance('\Innomatic\Core\InnomaticContainer')->getCurrentUser()->getLanguage());
...
function action_newcompany($eventData) {
    ...
    if ($innowork_company->Create($eventData, \Innomatic\Core\InnomaticContainer::instance('\Innomatic\Core\InnomaticContainer')->getCurrentUser()->getUserId())) {
        $GLOBALS['innowork-directory']['newcompanyid'] = $innowork_company->mItemId;
...
function main_showcompany($eventData) {
    ...
    if (isset($GLOBALS['innowork-directory']['newcompanyid'])) {
        $eventData['id'] = $GLOBALS['innowork-directory']['newcompanyid'];
    }
